...
<div id="header-wrapper">
	<div id="header" class="container">
		...
		<div id="menu">
			<ul>
<li ><a href="index.php">Homepage</a></li><li class="current_page_item"><a href="userguide.php">User Guide</a></li><li><a href="screenshots.php">Screenshots</a></li><li><a href="about.php">About</a></li><li><a href="contact.php">Contact</a></li>
			</ul>
		</div>
	</div>
		...
		<div id="content">
			...
			<div class="post">
				...
				<div class="entry">
					...
					<figure><img src="./images/SeaPal-Southampton-OSM.jpg" alt="SeaPal-Southampton-OSM" width="580" height="435"><figcaption>OpenSeaMap Map view</figcaption></figure>
					<p>
